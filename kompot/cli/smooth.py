"""CLI command for expression smoothing."""
...
from ..anndata.smooth import smooth_expression
...
def add_smooth_parser(subparsers) -> argparse.ArgumentParser:
    """Add expression smoothing subcommand parser.
    ...
    parser = subparsers.add_parser(
        "smooth",
        help="Expression smoothing via GP regression",
        description="Smooth gene expression for a single condition using GP regression",
    )
    ...
    parser.add_argument(
        ...
        "--table-output",
        type=str,
        help="Output gene-level summary table (.csv or .tsv) with mean smoothed values and std.",
    )
    ...
    parser.add_argument(
        "--condition",
        type=str,
        help="Which condition to smooth (requires --groupby). If omitted, all cells are used.",
    )
    ...
    parser.add_argument(
        "--result-key",
        type=str,
        help="Key for storing results in adata.uns (default: kompot_smooth)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        help="Subset of genes to smooth (default: all)",
    )
...
def run_smooth(args):
    ...
    logger.info("Starting expression smoothing")
    ...
    if args.table_output:
        ...
        logger.info(f"Saving smoothing summary to {table_path}")
    ...
    logger.info("Expression smoothing completed successfully")
