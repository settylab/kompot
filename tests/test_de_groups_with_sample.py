...
def test_de_groups_with_sample_col():
    ...
    conditions = np.array(['Cond1'] * 15 + ['Cond2'] * 15 + ['Cond1'] * 15 + ['Cond2'] * 15)
    ...
    groups_dict = {
        'TypeA': cell_types == 'TypeA',
        'TypeB': cell_types == 'TypeB'
    }
    ...
    assert mean_lfc_groups.shape == (10, 2), f"Expected shape (10, 2), got {mean_lfc_groups.shape}"
