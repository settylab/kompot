...
def create_test_anndata(
    n_cells=60, n_genes=20, with_categorical=False, with_continuous=False
):
...
class TestVolcanoDE:
    ...
    def test_basic_functionality(self):
        ...
        fig = volcano_de(self.adata, run_id=0, return_fig=True)
        assert fig is not None
    ...
    def test_gene_labels_parameter(self):
        ...
        gene_annotations = [
            ...
            if hasattr(ann, "get_text") and ann.get_text() in self.adata.var_names
        ]
        ...
        gene_labels_list = [
            ...
            "gene_1",
            "gene_9",
        ]  # gene_1 overlaps with highlight
    ...
    def test_key_inference(self):
        ...
        lfc_key, score_key = _infer_de_keys(
            self.adata, lfc_key="mean_lfc", score_key="mahalanobis"
        )
    ...
    def test_error_handling(self):
        ...
        empty_highlight_groups = [
            {"genes": [], "name": "Empty Group", "color": "#FF5733"}
        ]
        fig = volcano_de(
            self.adata,
            lfc_key="de_run1_mean_lfc_A_to_B",
