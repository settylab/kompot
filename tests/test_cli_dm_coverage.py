...
class TestDMRunMissingDependency:
    ...
    def test_run_dm_missing_palantir(self, sample_adata_with_pca, tmp_path, monkeypatch):
...
""")
        ...
        try:
            ...
            def mock_run_dm(adata, **kwargs):
                ...
                adata.obsm['DM_EigenVectors'] = np.random.randn(adata.n_obs, kwargs.get('n_components', 10))
...
class TestDMArgumentMapping:
    ...
    def test_dm_argument_conversion(self, sample_adata_with_pca, tmp_path, monkeypatch):
        ...
        sample_adata_with_pca.obsm['custom_pca'] = sample_adata_with_pca.obsm['X_pca'].copy()
