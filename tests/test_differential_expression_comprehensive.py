...
class TestDifferentialExpressionCoverage:
    ...
    def test_compute_differential_expression_with_cell_filter(self, basic_adata):
        ...
        with pytest.raises(
            Exception
        ):  # Should raise because not enough cells in one condition
    ...
    def test_compute_differential_expression_with_single_condition_variance(
        self, basic_adata
    ):
    ...
    def test_compute_differential_expression_store_posterior_covariance(
        self, basic_adata
    ):
